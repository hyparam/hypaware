...
**Date:** 2026-08-07
**Extended-by:** [LLP 0268](./0268-lane-answers-commit-with-the-config.decision.md) (#standing-answer: "each lane's stated default" is the standing answer where a lane has one, so accepting cannot retire a set `hyp policy folders ask`)
