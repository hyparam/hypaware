...
**Author:** Phil / Claude
**Date:** 2026-08-17
**Extended-by:** LLP 0266 (the row shape gains a `cwd` column, so the export and query seams can withhold `local-only` rows)
...
> **Extended-by [LLP 0266](./0266-behavioral-rows-carry-cwd.decision.md):**
