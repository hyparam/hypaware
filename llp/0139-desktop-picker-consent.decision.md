...
**Superseded-by:** [LLP 0296](./0296-claude-desktop-gateway-capture-retired.issue.md) (the Desktop picker row and its consent-gated setup command are deleted. #compose-the-whole-dependency-set and #repair-must-be-runnable remain in force for every other client row)
