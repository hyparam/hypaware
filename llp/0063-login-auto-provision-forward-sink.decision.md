...
**Author:** Kenny / Claude
**Date:** 2026-07-04
**Extended-by:** LLP 0206 (#connection-levels: `daemon uninstall` cascades down to the client attaches too, since a client left pointed at the removed gateway port is broken, not merely stale); LLP 0407 (#dropped: the pre-auth notice no longer names the org-config consequence)
