...
**Superseded-by:** [LLP 0296](./0296-claude-desktop-gateway-capture-retired.issue.md) (the managed-plist attach is removed: it changes Claude Desktop's account context. The #desktop-rows-are-distinguishable User-Agent stamping survives in `@hypaware/claude` and is untouched)
