...
(#transition-plus-rewarn: the strand accepted there is cleared where
retention deletes the partition, and the rejected-value comparison is
qualified by type; #consequences: the silent recovery accepted there is
