...
**Date:** 2026-08-06
**Extended-by:** LLP 0203 (#first-ask: the enrolled closing sequence gains a sync offer ahead of the ask), LLP 0388 (#first-ask: one row gathers its evidence before the launch; #onboarding-list: that row starts the client in a HypAware-owned run directory)
