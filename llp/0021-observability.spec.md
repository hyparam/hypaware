...
**Extended-by:** LLP 0393 (draft request for a separate opt-in product channel), LLP 0318 (opt-in, bounded process/runtime diagnostic metrics),
...
invariant behind the V1 self-loop criterion
