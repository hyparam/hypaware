...
**Extended-by:** LLP 0266 (a registration's `usage` line and its parser are one declaration, and every visible core command refuses input it does not know with exit 2)
