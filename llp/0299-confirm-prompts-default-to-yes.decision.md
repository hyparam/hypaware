...
**Extended-by:** [LLP 0433](./0433-attended-setup-saves-without-asking.decision.md) (the config overwrite confirm this doc lists among the `[Y/n]` prompts it leaves alone is gone: an attended setup backs up the config and saves without asking.)
