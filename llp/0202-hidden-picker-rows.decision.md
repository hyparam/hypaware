...
**Extended-by:** [LLP 0296](./0296-claude-desktop-gateway-capture-retired.issue.md#kill-switch) (`hidden` is not a kill switch: it keeps `--source <id>` composing the row, so a retired route deletes its picker block instead)
