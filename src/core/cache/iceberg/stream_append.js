 ...
 *
 * @ref LLP 0209#descriptor-parking [implements]: cap descriptors, not
 *   open files.
 */
 ...
 * rows: the exact defect LLP 0209 set out to fix. A global budget spends
 ...
 *
 * @ref LLP 0209#retained-metadata [implements]: bound the row-group
 ...
 *
 * @ref LLP 0209#row-groups [implements]: batches become row groups; files
 *   roll on bytes written.
 * @ref LLP 0209#retained-metadata [implements]: and on retained row-group
...
export async function openStreamingAppend({ tableDir, columns, targetFileBytes, appendOptions }) {
   ...
   *
   * @ref LLP 0209#descriptor-parking [implements]: park the descriptor,
   *   keep the file.
   * @param {string} key
 ...
 *
 * @ref LLP 0209#schema-probe: derive the parquet schema from icebird rather
