 ...
 * `--no-browser`). The caller owns the protocol and fallback instructions.
 *
 * @param {string} url
 * @param {{ platform?: NodeJS.Platform, spawnImpl?: typeof spawn }} [opts]
 * @returns {boolean}
 * @ref LLP 0058#d8 [implements]: best-effort browser opener with a caller-owned printed-URL fallback
 */
