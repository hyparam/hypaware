  ...
  return [
    ...
    },
    {
      ...
      help: [
        ...
        '',
        'Pass a preset name to skip the walkthrough, or --yes for a',
        'non-interactive install driven by --client / --source flags.',
      ].join('\n'),
      run: runInit,
    },
    {
    ...
    },
    {
      ...
      help: [
        ...
        'and loses no Desktop history by not doing so. Claude Desktop exposes no',
        'user-writable settings file and is handled by hyp claude-desktop',
        'instead (see hyp claude-desktop --help), when that plugin is active.',
        '',
