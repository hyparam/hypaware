...
function buildCoreCommands(registry) {
  return [
    ...
    },
    {
      ...
      usage: coreUsage('ask'),
      help: [
        'With no argument, asks the one question worth asking first: what single',
        'change would recover the most wasted effort. HypAware measures the last',
        ...
        'into one folder under the system temp directory, rewritten each time,',
        'and starts an attached client in that folder so the session stays out of',
        'your home directory and out of whatever repo you ran it from. The client',
