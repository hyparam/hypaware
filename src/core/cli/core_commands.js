  ...
  return [
    ...
    },
    {
      ...
      help: [
        ...
        'Folders must contain only supported Markdown files. HTML, raw HTML',
        'inside Markdown, images, and client assets are not accepted. Put HTML',
        'examples in code fences. The server renders the report for the team;',
        'no local rendering step is needed. Folder uploads use system tar',
