  ...
  return [
    ...
    },
    {
      ...
      help: [
        ...
        '',
        'The first row, "The one change worth making", is answered from evidence',
        'HypAware gathers before the client starts: it measures the last 30 days,',
        'picks what kind of change would recover the most, and writes the files',
        'into a folder under $HYP_HOME/ask. The client is started in that folder,',
        'so the session and anything it writes stay out of your home directory.',
        '',
