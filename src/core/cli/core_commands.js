  ...
  return [
    ...
    },
    {
      ...
      help: [
        ...
        'A proxy-mode detach keeps the local interception CA and any keychain',
        'trust an earlier release was granted, because no attach re-creates',
        'either; --purge removes both as well.',
        '--dry-run reports what would change without writing.',
      ].join('\n'),
