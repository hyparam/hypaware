  ...
  return [
    ...
    },
    {
      ...
      help: [
        ...
        'time), and starts an attached client in that folder so the session',
    ...
    },
    {
      name: 'privacy purge',
      aliases: ['purge'],
      summary: 'Delete recorded rows locally, optionally purge a session on a server',
      usage: 'hyp privacy purge <path> | --session <id> [--remote <target>] | --ignored | --all [--yes] [--json]',
      help: [
        ...
        '--remote <target> also purges session-keyed rows from that server\'s cache and archive.',
        ...
        'Without --remote this command never deletes exported copies.',
