...
// privacy document, and `hyp client detach --help` all still described attach adding
...
// it is a leftover nothing re-creates and only `hyp client detach <client> --purge` or
 ...
 * `hyp client detach --help`. Adding a fourth document means writing its own pair of
...
const SCANNED = [
  {
    ...
    banned: [
      ...
      {
        phrase: '`hyp client detach <client>` unsets the variable and removes the agent',
