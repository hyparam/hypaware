...
export async function run({ harness, expect }) {
  ...
  const blobStore = /** @type {import('../../../collectivus-plugin-kernel-types').BlobStore & { bucket?: string, prefix?: string }} */ (
  ...
  const tableFormat = /** @type {import('../../../collectivus-plugin-kernel-types').TableFormatProvider} */ (
 ...
 *
 * @param {import('../../../collectivus-plugin-kernel-types').BlobStore} blobStore
 */
