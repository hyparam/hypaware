...
export async function activate(ctx) {
  ...
  ctx.commands.register({ name: 'enrichment', aliases: ['enrich'], plugin: PLUGIN_NAME, category: 'additional', audience: 'operator', summary: 'Context-graph enrichment (subcommands: propose, curate, backfill, status)', usage: 'hyp enrichment <propose|curate|backfill|status>', run: runEnrich })
