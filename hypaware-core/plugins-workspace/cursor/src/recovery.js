...
import { listCursorSessions, safeError } from './native.js'
      ...
      try {
        ...
        for (const session of sessions) {
          ...
          try {
            ...
            const snapshot = await decoder.read(session, ctx.sweep && !ctx.dryRun && previous?.windowKey === windowKey ? previous.root : undefined)
