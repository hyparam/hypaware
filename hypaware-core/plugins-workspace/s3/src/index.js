...
/**
 * @import { BlobStore, ExportBatch, ExportOptions, ExportResult, PluginActivationContext, QueryPartition, QueryRegistry, QueryStorageService, Sink, SinkCreateContext, SinkEncoder } from '../../../../hypaware-plugin-kernel-types.js'
      ...
      for (const partition of batch.partitions) {
        try {
          ...
          if (reader.empty) {
            ...
            // No new payload rows since the watermark ⇒ PUT no object (0 bytes).
